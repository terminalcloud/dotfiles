...
openssl req -new -key $DIRECTORY/$1.key -out $DIRECTORY/$1.csr
...
openssl x509 -req -days 365 -in $DIRECTORY/$1.csr -CA ca.crt -CAkey ca.key -set_serial 01 -out $DIRECTORY/$1.crt

scp -i $2 /etc/cloudlabs/certs/client/$1.key $3@$1:/etc/cloudlabs/certs/
